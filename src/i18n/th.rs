...
pub const HINT_MODULE_LIST:  &str = "↑↓/jk:เลื่อน  d:ลบ  a:สลับทั้งหมด/กำหนดเอง  Esc:ย้อนกลับ";
pub const MODULE_LIST_AUTH_DESC: &str = "ต้องการสิทธิ์ผู้ดูแลระบบเพื่อแสดงรายการโมดูล จะโหลดอัตโนมัติหลังการยืนยันตัวตน";
pub const HINT_MODULE_DETAIL:       &str = "↑↓/jk:เลื่อน  Esc:ย้อนกลับ";
pub const MODULE_DETAIL_AUTH_DESC:  &str = "ต้องการสิทธิ์ผู้ดูแลระบบเพื่อดึงเนื้อหาโมดูล";
pub const MODULE_DETAIL_TITLE:      &str = "รายละเอียดโมดูล";
pub const MODULE_DETAIL_CIL_TITLE:  &str = "กฎ CIL";
...
pub const OPT_RESTORECON_DESC:     &str = "ลองสิ่งนี้ก่อน คืนค่า file context เริ่มต้น (แก้ไข label ที่สูญหาย)";
pub const OPT_CUSTOM_POLICY_LABEL: &str = "สร้างและนำโมดูลนโยบายที่กำหนดเองไปใช้ (audit2allow)";
pub const OPT_CUSTOM_POLICY_DESC:  &str = "สร้างนโยบายอัตโนมัติด้วย audit2allow หากทราบเส้นทาง ให้กด P ก่อน";
pub const OPT_PERMISSIVE_DESC:     &str = "⚠ ปิดการปฏิเสธทั้งหมดของโดเมน ความเสี่ยงด้านความปลอดภัยสูง ใช้เพื่อการสืบสวนเท่านั้น";
...
pub const ANALYSIS_PATH_UNKNOWN_HINT: &str = " * ไม่ทราบเส้นทาง กด P เพื่อระบุเส้นทางไดเรกทอรีและดูวิธีแก้ไขที่ดีที่สุด";
pub const PATH_INPUT_TITLE:  &str = " ป้อนเส้นทางไดเรกทอรี";
pub const PATH_INPUT_PROMPT: &str = " ป้อนเส้นทางสัมบูรณ์ (เช่น: /var/log/myapp)";
pub const PATH_INPUT_HINT:   &str = " Enter: ยืนยัน  Esc: ยกเลิก";
pub const OPT_PATH_INPUT_LABEL: &str = "ป้อนเส้นทางสัมบูรณ์เพื่อเปิดใช้ restorecon/fcontext";
pub const OPT_PATH_INPUT_DESC:  &str = "ไม่ทราบเส้นทาง — ไม่สามารถแสดงตัวเลือก A/B ได้ ป้อนเส้นทางสัมบูรณ์เพื่อแสดงขั้นตอนแก้ไขป้ายกำกับ (restorecon / semanage fcontext)";
...
pub fn module_list_title(custom: usize, total: usize, show_all: bool) -> String {
    if show_all {
        format!(" รายการโมดูลนโยบาย  {} โมดูล ", total)
    } else {
        format!(" โมดูลกำหนดเอง  {} / ทั้งหมด {} ", custom, total)
    }
}
...
pub fn analysis_dir_label_check(dir: &str) -> String {
    format!(" ตรวจสอบป้ายกำกับไดเรกทอรีด้วย: ls -dZ {} หากป้ายกำกับไม่ถูกต้อง ให้ลอง restorecon ก่อน", dir)
}
