...
pub const HINT_MODULE_LIST:  &str = "↑↓/jk:تنقل  d:حذف  a:تبديل الكل/مخصص  Esc:رجوع";
pub const MODULE_LIST_AUTH_DESC: &str = "مطلوب صلاحيات المسؤول لعرض قائمة الوحدات. سيتم التحميل تلقائياً بعد المصادقة.";
pub const HINT_MODULE_DETAIL:       &str = "↑↓/jk:تمرير  Esc:رجوع";
pub const MODULE_DETAIL_AUTH_DESC:  &str = "مطلوب صلاحيات المسؤول لاستخراج محتوى الوحدة.";
pub const MODULE_DETAIL_TITLE:      &str = "تفاصيل الوحدة";
pub const MODULE_DETAIL_CIL_TITLE:  &str = "قواعد CIL";
...
// ── خيارات الحل (ثابتة) ──────────────────────────────────────────────────────
pub const OPT_RESTORECON_DESC:     &str = "جرّب هذا أولاً. استعادة سياق الملف الافتراضي (إصلاح التسميات المفقودة).";
pub const OPT_CUSTOM_POLICY_LABEL: &str = "إنشاء وتطبيق وحدة سياسة مخصصة (audit2allow)";
pub const OPT_CUSTOM_POLICY_DESC:  &str = "إنشاء سياسة تلقائياً باستخدام audit2allow. إذا كان المسار معروفاً، اضغط P أولاً.";
pub const OPT_PERMISSIVE_DESC:     &str = "⚠ يعطّل جميع الرفض لهذا النطاق. خطر أمني كبير. للاستخدام في التحقيق فقط.";
...
pub const ANALYSIS_PATH_UNKNOWN_HINT: &str = " * المسار غير معروف. اضغط P لتحديد المسار وعرض أفضل حل.";
pub const PATH_INPUT_TITLE:  &str = " إدخال مسار الدليل";
pub const PATH_INPUT_PROMPT: &str = " أدخل المسار المطلق (مثال: /var/log/myapp)";
pub const PATH_INPUT_HINT:   &str = " Enter: تأكيد  Esc: إلغاء";
pub const OPT_PATH_INPUT_LABEL: &str = "أدخل المسار المطلق لتفعيل restorecon/fcontext";
pub const OPT_PATH_INPUT_DESC:  &str = "المسار غير معروف — الخياران A/B غير متاحَين. أدخل المسار المطلق لعرض خطوات تصحيح التسمية (restorecon / semanage fcontext).";
...
pub fn module_list_title(custom: usize, total: usize, show_all: bool) -> String {
    if show_all {
        format!(" وحدات السياسة  {} وحدة ", total)
    } else {
        format!(" الوحدات المخصصة  {} / {} إجمالاً ", custom, total)
    }
}
...
pub fn analysis_dir_label_check(dir: &str) -> String {
    format!(" تحقق من تسمية المجلد باستخدام: ls -dZ {}. إذا كانت التسمية خاطئة، جرّب restorecon أولاً.", dir)
}
