...
SELinux の AVC デナイアルを TUI（テキストユーザーインターフェース）で確認・対処するための Rust 製管理ツール。

## 概要

SELinux の `ausearch` 出力を解析し、AVC デナイアルの一覧表示・原因分析・対処コマンドの実行を対話的に行えます。

- AVC デナイアルの集計・一覧表示（プロセス / 操作 / 対象 / 発生件数）
- 原因分析と解決策の自動候補提示
